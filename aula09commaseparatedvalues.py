...
CAMINHO_CSV = Path(__file__).parent / 'aula09ex.csv'
...
CAMINHO_CSV_ESCRITA = Path(__file__).parent / 'aula09escrita.csv'

lista_dict_clientes = [
    {'Nome': 'Luiz Otávio', 'Endereço': 'Av 1, 22'},
    {'Nome': 'Maria Sol', 'Endereço': 'Av 2, 23'},
]
...
with open(CAMINHO_CSV_ESCRITA, 'w', encoding='utf8') as arquivo:
    nome_colunas = lista_dict_clientes[0].keys()
    escritor = csv.DictWriter(arquivo, fieldnames=nome_colunas)
    escritor.writeheader()

    for cliente in lista_dict_clientes:
        print(cliente)
